...
import { usePopularMeals } from "@hooks/useMeals";
import Image from "next/image";

export default function Popular() {
  const { data: mealsData = [], isLoading, isError, error } = usePopularMeals();

  if (isLoading) {
    return (
      <section className="container mx-auto px-4 my-14 py-10 text-center">
        <p className="text-slate-500">Loading popular items...</p>
      </section>
    );
  }
