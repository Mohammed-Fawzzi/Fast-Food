...
import { contactInfo } from "@constants/links";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 my-7">
          ...
          <div className="flex flex-col items-center space-y-3 p-6 bg-orange-100 shadow-lg text-center">
            ...
            <a
              ...
              className="text-gray-500 text-sm sm:text-base hover:text-gray-800"
            >
              {contactInfo.phone}
            </a>
          </div>
          <div className="flex flex-col items-center space-y-3 p-6 bg-orange-100 shadow-lg text-center">
            ...
            <a
              ...
              className="text-gray-500 text-sm sm:text-base hover:text-gray-800 break-all"
            >
              {contactInfo.email}
            </a>
          </div>
        ...
        <div className="bg-orange-50 p-8 my-10 shadow-lg">
          ...
          <div className="mt-4">
            <form>
              <div className="py-2">
                <label htmlFor="name" className="text-xl sm:text-2xl font-bold">
                  Name :
                </label>
                <input
                  type="text"
              ...
              <div className="py-2">
                <label htmlFor="phone" className="font-bold text-xl sm:text-2xl">
                  Phone :
                </label>
                <input
                  type="text"
              ...
              <div className="mb-4 py-2">
                <label
                  htmlFor="message"
                  className="block mb-1 text-xl sm:text-2xl font-bold"
                >
                  Message :
                </label>
                <textarea
