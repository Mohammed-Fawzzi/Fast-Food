    ...
    <section className="my-14 pt-10 min-h-screen flex flex-col justify-center items-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl">
        <div className="flex justify-center">
          <Image src="/pro.png" alt="not-found" width={500} height={300} />
        </div>
        <div className="flex flex-col justify-center items-center text-center md:text-left">
          ...
          <p className="mt-4 px-4 md:px-0 text-center">
            Oops! It looks like the page you are searching for has taken a
            detour. Lets guide you back to the heart of TNC.
          </p>
